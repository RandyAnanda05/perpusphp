...
if(isset($_POST["submit"])) {
    if (tambahperpus($_POST) >0) {
        ...
        echo "<script>
            alert('data gagal/batal ditambah');
            document.location.href='index.php';
            </script>";
                ...
                <form action="" method="post">
                    <div class="mb-14" >
                        <div>
                            ...
                            <input class="outline-none transition-all duration-100 focus:border-b-4 focus:border-sky-500 block w-full rounded-lg bg-transparent border-b-2 border-slate-300" name="id" type="text" >
                        </div>
                        <div>
                            <span class="font-bold">Judul Buku : </span>
                            <input class="outline-none transition-all duration-100 focus:border-b-4 focus:border-sky-500 block w-full rounded-lg bg-transparent border-b-2 border-slate-300 " name="judul" type="text"   >
                        </div>
                        <div>
                            <span class="font-bold">Penulis : </span>
                            <input class="outline-none transition-all duration-100 focus:border-b-4 focus:border-sky-500 block w-full rounded-lg bg-transparent border-b-2 border-slate-300" name="penulis" type="text"   >
                        </div>
                        <div>
                            <span class="font-bold">Tahun Terbitan : </span>
                            <input class="outline-none transition-all duration-100 focus:border-b-4 focus:border-sky-500 block w-full rounded-lg bg-transparent border-b-2 border-slate-300 " name="tahun" type="text"   >
                        </div>
                        <div>
                            <span class="font-bold">ISBN : </span>
                            <input class="outline-none transition-all duration-100 focus:border-b-4 focus:border-sky-500 block w-full rounded-lg bg-transparent border-b-2 border-slate-300 " name="isbn" type="text" >
                        </div>
                    </div>
                    <div class="absolute bottom-4 right-4 font-bold">
                     <button type="submit" name="submit" class="bg-green-500 p-2 w-15 h-11 rounded-md" onclick="return confirm('yakin data yang diinput sudah benar ?');"> TAMBAH </button>
                    </div>
                </form>
                </div>
            </div>
